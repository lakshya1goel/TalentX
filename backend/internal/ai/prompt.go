...
func (a *JobClient) CandidateProfilePrompt(locationPreference dtos.LocationPreference) string {
...
func (a *JobClient) ParseLocationPreference(locationPreference dtos.LocationPreference) string {
	locationGuidance := "\n\n5. **Location Preferences:** "
